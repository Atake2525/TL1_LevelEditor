...
class MYADDON_OT_export_scene(bpy.types.Operator, bpy_extras.io_utils.ExportHelper):
    ...
    def export(self):
        ...
        print("シーン情報出直開始... %r" % self.filepath)
    ...
    def export_json(self):
        ...
        for object in bpy.context.scene.objects:
            ...
            #シーン直下のオブジェクトをルートノード(深さ0)とし、再起関数で走査
            self.parse_scene_recursize_json(json_object_root["objects"], object, 0)
    ...
    def parse_scene_recursive(self, file, object, level):
        ...
        # #親オブジェクトの名前を表示
        # if object.parent:
        #     self.write_and_print(file, "Parent:\n" + object.parent.name)
        file.write("\n")
    ...
    def parse_scene_recursize_json(self, data_parent, object, level):
        ...
        if len(object.children) > 0:
            ...
            #子ノードへ進む(深さが１上がる)
            for child in object.children:
                self.parse_scene_recursize_json(json_object["children"], child, level + 1)
...
class MYADDON_OT_add_collider(bpy.types.Operator):
    bl_idname = "myaddon.myaddon_ot_add_cllider"
    bl_label = "コライダー 追加"
