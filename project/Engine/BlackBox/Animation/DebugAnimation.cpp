...
DebugAnimation* DebugAnimation::instance = nullptr;

DebugAnimation* DebugAnimation::GetInstance() {
	if (instance == nullptr) {
		instance = new DebugAnimation;
	}
	return instance;
}

void DebugAnimation::Finalize() {
	delete instance;
	instance = nullptr;
}

void DebugAnimation::Initialize(DirectXBase* directxBase) {
	directxBase_ = directxBase;
	CreateGraphicsPipeLineState();
}

void DebugAnimation::CreateRootSignature() {
...
void DebugAnimation::CreateGraphicsPipeLineState() {
	CreateRootSignature();
	// PSOを作成する
...
void DebugAnimation::ShaderDraw() {
